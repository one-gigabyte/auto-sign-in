...
var url = "https://www.52ssr.info/auth/login";
var checkinUrl="https://www.52ssr.info/user/checkin";
function process(){
    console.log('start');
...
function get(cookie){
    superagent.get("https://www.52ssr.info/user")
    .set("Cookie",cookie)
